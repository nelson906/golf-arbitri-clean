...
class ClubController extends Controller
{
    ...
    // NOTA (audit 2026-07): rimossi deactivate() (doppione di toggleActive,
    // stessa guardia e semantica) ed export() (route irraggiungibile perché
    // definita dopo /{club}, mai linkata da alcuna view).
}
