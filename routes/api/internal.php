...
|--------------------------------------------------------------------------
| CLEANED: Removed routes calling non-existent controller methods
| Kept only working inline closures and verified controller methods
*/
...
Route::middleware('auth')->group(function () {
    ...
    // Clubs by zone (uses existing controller method)
    Route::get('/clubs/by-zone', [\App\Http\Controllers\Admin\TournamentController::class, 'getclubsByZone']);
});
