...
@section('page-title', 'Modifica Email Istituzionale')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <h2 class="text-xl font-semibold mb-6">Modifica Email Istituzionale</h2>

            <form method="POST" action="{{ route('super-admin.institutional-emails.update', $institutionalEmail) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="receive_all_notifications" id="receive_all_notifications"
                                       value="1"
                                       {{ old('receive_all_notifications', $institutionalEmail->receive_all_notifications) ? 'checked' : '' }}
                        ...
                        <div id="notification-types-section" class="{{ old('receive_all_notifications', $institutionalEmail->receive_all_notifications) ? 'hidden' : '' }}">
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="is_active" id="is_active" value="1"
                               {{ old('is_active', $institutionalEmail->is_active) ? 'checked' : '' }}
                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
