        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <p class="mt-1 text-sm text-yellow-700">
                    Sono stati rilevati <strong>{{ $summary['total_issues'] }}</strong> problemi nelle assegnazioni ({{ $issuePercentage }}% del totale).
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="rounded-md {{ $summary['total_issues'] > 0 ? 'bg-red-500' : 'bg-green-500' }} bg-opacity-10 p-3">
                            <svg class="h-8 w-8 {{ $summary['total_issues'] > 0 ? 'text-red-600' : 'text-green-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                @if($summary['total_issues'] > 0)
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200">
            <div class="p-6">
                ...
                @if($summary['conflicts'] > 0)
                    ...
                    <a href="{{ route('admin.assignment-validation.conflicts') }}" class="inline-flex items-center justify-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200">
            <div class="p-6">
                ...
                @if($summary['missing_requirements'] > 0)
                    ...
                    <a href="{{ route('admin.assignment-validation.missing-requirements') }}" class="inline-flex items-center justify-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                        </svg>
                        Visualizza Problemi
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200">
            <div class="p-6">
                ...
                @if($summary['overassigned'] > 0)
                    ...
                    <a href="{{ route('admin.assignment-validation.overassigned') }}" class="inline-flex items-center justify-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                        </svg>
                        Visualizza Arbitri
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200">
            <div class="p-6">
                ...
                @if($summary['underassigned'] > 0)
                    ...
                    <a href="{{ route('admin.assignment-validation.underassigned') }}" class="inline-flex items-center justify-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                        </svg>
                        Visualizza Arbitri
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="flex-grow">
                        <h4 class="font-medium text-gray-900">Risoluzione Automatica</h4>
                        <p class="text-sm text-gray-600">Risolvi automaticamente i conflitti dove possibile</p>
                    </div>
                    <form action="{{ route('admin.assignment-validation.fix-conflicts') }}" method="POST" class="ml-4" onsubmit="return confirm('Vuoi tentare di risolvere automaticamente i conflitti? Questa azione modificherà alcune assegnazioni.')">
                        @csrf
                ...
                {{-- Esporta Report - Commentato: metodo export() non implementato
                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="flex-grow">
                        <h4 class="font-medium text-gray-900">Esporta Report</h4>
                        <p class="text-sm text-gray-600">Scarica un report completo dei problemi rilevati</p>
                    </div>
                    <a href="{{ route('admin.assignments.export') }}?validation=1" class="ml-4 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 text-sm font-medium">
                        Scarica
                    </a>
                </div>
                --}}
