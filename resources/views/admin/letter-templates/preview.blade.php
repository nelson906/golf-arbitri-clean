                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="mt-4 p-3 bg-blue-50 rounded-md">
                            <p class="text-xs text-blue-700">
                                💡 <strong>Nota:</strong> Questi sono dati di esempio utilizzati per mostrare come apparirà
                                l'email finale. I dati reali verranno sostituiti automaticamente durante l'invio.
                            </p>
                        </div>
                    </div>
