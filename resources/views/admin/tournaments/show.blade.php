                            ...
                            <p class="text-gray-900">
                                @if ($tournament->tournamentType)
                                    ...
                                    @if ($tournament->tournamentType->is_national)
                                        <span
                                            class="ml-2 px-2 py-1 text-xs bg-purple-100 text-purple-800 rounded">Nazionale</span>
                                    @endif
                                @else
                            ...
                            <div class="flex items-center justify-between py-2 px-3 bg-gray-50 rounded hover:bg-gray-100">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.assignments.destroy', $assignment) }}" method="POST"
                                        class="inline" onsubmit="return confirm('Rimuovere questo arbitro dal torneo?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-red-600 hover:text-red-800" title="Rimuovi">
                                            🗑️
                                        </button>
                                    </form>
                                </div>
