                            ...
                            <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="draft" {{ request('status') === 'draft' ? 'selected' : '' }}>Bozza
                                        </option>
                                ...
                                <div>
                                    ...
                                    <select name="type"
                                        ...
                                        <option value="announcement"
                                            {{ request('type') === 'announcement' ? 'selected' : '' }}>
                                            Annuncio</option>
                                        <option value="alert" {{ request('type') === 'alert' ? 'selected' : '' }}>Avviso
                                        </option>
                                        <option value="maintenance"
                                            {{ request('type') === 'maintenance' ? 'selected' : '' }}>
                                            Manutenzione</option>
                                            ...
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div>
                                                        ...
                                                        <div class="text-sm text-gray-500">
                                                            {{ Str::limit(strip_tags($communication->content), 50) }}</div>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    @php
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $typeColors[$communication->type] ?? 'bg-gray-100 text-gray-800' }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    @if ($communication->status === 'published')
                                                        <span
                                                            class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Pubblicato</span>
                                                    @elseif($communication->status === 'draft')
                                                        <span
                                                            class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">Bozza</span>
                                                    @endif
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    @php
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $priorityColors[$communication->priority] ?? 'bg-gray-100 text-gray-800' }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    @if ($communication->zone)
                                                        <span
                                                            class="text-sm text-gray-500">{{ $communication->zone->name }}</span>
                                                    @else
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <div class="flex items-center justify-end gap-2">
                                                        ...
                                                        @if($communication->status === 'draft')
                                                            <form method="POST"
                                                                action="{{ route('admin.communications.publish', $communication) }}"
                                                                class="inline">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="submit"
                                                        ...
                                                        @endif
                                                        <form method="POST"
                                                            action="{{ route('admin.communications.destroy', $communication) }}"
                                                            class="inline"
