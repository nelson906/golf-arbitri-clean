                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Torneo</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Club</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Date</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Ruolo</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($tournaments as $tournament)
                                    @php
                                        $assignment = collect($assignments)->firstWhere('tournament_id', $tournament['id']);
                                    @endphp
                                    <tr>
                    ...
                    @if($availableTournaments->count() > 0)
                        <form action="{{ route('admin.career-history.add-tournament', $user) }}" method="POST">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Ruolo (opzionale)</label>
                                    <select name="role"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
