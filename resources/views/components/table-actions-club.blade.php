...
<div class="flex items-center justify-end space-x-2">
    {{-- Visualizza --}}
    <a href="{{ route('admin.clubs.show', $club) }}" class="text-indigo-600 hover:text-indigo-900" title="Visualizza">
    ...
    {{-- Modifica --}}
    <a href="{{ route('admin.clubs.edit', $club) }}" class="text-blue-600 hover:text-blue-900" title="Modifica">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('admin.tournaments.index', ['club_id' => $club->id]) }}"
        class="text-purple-600 hover:text-purple-900" title="Visualizza Tornei">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
