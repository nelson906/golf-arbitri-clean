...
export class QuadrantiLogic {
     ...
     * @typedef {{players: any[], playerIndices: number[], flightNumber?: number}} FlightGroup
     *
     * @returns {{early:{tee1:FlightGroup[],tee10:FlightGroup[]}, late:{tee1:FlightGroup[],tee10:FlightGroup[]}}}
     */
    buildURQuadrants(N, mod, source, internal = 'asc', earlyFlights = null, opts = {}) {
        ...
        const q1f = Math.floor(eF / 2);   // Early: Q1 = Tee 1 (Q2 = Tee 10 = eF - q1f)
        const q3f = Math.floor(lF / 2);   // Late:  Q3 = Tee 1 (Q4 = Tee 10 = lF - q3f)
        ...
        let lo = 1;
        const rng = (n) => { const r = /** @type {[number, number]} */ ([lo, lo + n - 1]); lo += n; return r; };
  ...
  generateDoubleTee(round) {
    ...
    generateTableHeader(doubleTee, modOverride) {
        ...
        const mod = parseInt(modOverride, 10) || parseInt(this.config.playersPerFlight, 10);
