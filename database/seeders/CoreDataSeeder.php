...
class CoreDataSeeder extends Seeder
{
    ...
    private function seedZones(): void
    {
        DB::table('zones')->insert([
            ['code' => 'SZR1', 'name' => 'Sezione Zonale Regole 1', 'email' => 'szr1@golf.it', 'is_national' => false, 'is_active' => true],
            ['code' => 'SZR2', 'name' => 'Sezione Zonale Regole 2', 'email' => 'szr2@golf.it', 'is_national' => false, 'is_active' => true],
            ['code' => 'SZR3', 'name' => 'Sezione Zonale Regole 3', 'email' => 'szr3@golf.it', 'is_national' => false, 'is_active' => true],
            ['code' => 'SZR4', 'name' => 'Sezione Zonale Regole 4', 'email' => 'szr4@golf.it', 'is_national' => false, 'is_active' => true],
            ['code' => 'SZR5', 'name' => 'Sezione Zonale Regole 5', 'email' => 'szr5@golf.it', 'is_national' => false, 'is_active' => true],
            ['code' => 'SZR6', 'name' => 'Sezione Zonale Regole 6', 'email' => 'szr6@golf.it', 'is_national' => false, 'is_active' => true],
            ['code' => 'SZR7', 'name' => 'Sezione Zonale Regole 7', 'email' => 'szr7@golf.it', 'is_national' => false, 'is_active' => true],
            ['code' => 'CRC', 'name' => 'Central Referee Committee', 'email' => 'crc@golf.it', 'is_national' => true, 'is_active' => true],
        ]);
    }
    ...
    private function seedTournamentTypes(): void
    {
        DB::table('tournament_types')->insert([
            ...
            // Nazionali
            ['name' => 'Gara Nazionale 36 buche', 'short_name' => 'GN-36', 'is_national' => true, 'level' => 'nazionale', 'required_level' => 'regionale', 'min_referees' => 2, 'max_referees' => 4, 'sort_order' => 25, 'is_active' => true],
            ['name' => 'Gara Nazionale 54 buche', 'short_name' => 'GN-54', 'is_national' => true, 'level' => 'nazionale', 'required_level' => 'regionale', 'min_referees' => 2, 'max_referees' => 4, 'sort_order' => 30, 'is_active' => true],
